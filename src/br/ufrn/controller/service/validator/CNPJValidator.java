...
import br.ufrn.exceptions.CNPJInvalidoException;
import br.ufrn.exceptions.ValidationException;

public class CNPJValidator implements ValidatorInterface<String> {

	@Override
	public void validate(String value) throws CNPJInvalidoException {
		if(!isCNPJ(value)){
